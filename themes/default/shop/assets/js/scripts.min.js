    ...
    $.ajax({
        ...
        success: function(t) {
            ...
            if (t.cart != undefined) {
                ...
                sa_alert("Notice!", "Item is not added to cart. Desire Quantity is out of Stock", 'info', 5000);
            }
        }
    });
...
function gen_html(t) {
    ...
    if (t || (e += "<h4>No product found, please try to search or filter again.</h4>"), 1 == site.settings.products_page && ($("#results").empty(), $(".grid").isotope("destroy").isotope()), $.each(t, function(s, r) {
                ...
                var t = r.name;
                var count = 22;
                if (r.promotion == null || r.promotion == 0 || r.promo_price == null || r.promo_price == '') {
                    var price = '<div class="price"><span class="price-new">' + r.price + '</span></div>';
                    var desk_price = '<span class="price"> ' + r.price + '</span>';
                } else {
                    if (r.promotion) {
                        var price = '<div class="price"><span class="price_new">' + r.promo_price + '</span><span class="price-old">' + r.price + '</span></div>';
                        var desk_price = '<span class="price">' + r.promo_price + '</span>' +

                            '<span class="price-before-discount"> ' + r.price + '</span>';
                    }
                ...
                if (isMobile) {
                    ...
                    //1 != site.settings.products_page && (0 === s && (e += ''), s % a === 0 && (e += '')), e +='<div class="col-sm-6 col-md-4 wow fadeInUp"><div class="products"><div class="product"><div class="product-image"><div class="image"><a href="'+ site.site_url + "product/" + r.slug +'"><img  src="' + site.base_url + "assets/uploads/" + r.image + '" alt="test  "></a> </div></div><div class="tag new"><span>new</span></div></div><div class="description"></div> <div class="product-price"> <span class="price"> '+r.price+'</span></div></div><div class="cart clearfix animate-effect"> <div class="action"><ul class="list-unstyled"><li class="add-cart-button btn-group"<button class="btn btn-primary icon addToCart add-to-cart"  data-id="'+r.id+'"  data-toggle="dropdown" type="button"> <i class="fa fa-shopping-cart"></i> </button><button class="btn btn-primary cart-btn addToCart add-to-cart" type="button">Add to cart</button></li><li class="lnk wishlist"> <a class="add-to-cart wishlist add-to-wishlist" href="detail.html" data-id="'+r.id+'" title="Wishlist"> <i class="icon fa fa-heart"></i> </a> </li><li class="lnk"> <a class="add-to-cart wishlist add-to-wishlist" href="detail.html" data-id="'+r.id+'" title="Compare"> <i class="fa fa-signal"></i> </a> </li><ul> </div> </div> </div> </div> </div>', 1 != site.settings.products_page && s + 1 === t.length && (e += "</div>");
                    1 != site.settings.products_page && (0 === s && (e += ''), s % a === 0 && (e += '')), e += '<div class="col-sm-6 col-md-4 wow fadeInUp asim">' +
                        '<div class="products">' +
                        '<div class="product">' +
                        '<div class="product-image">' +
                        '<div class="image"> <a href="' + site.site_url + "product/" + r.slug + '"><img  src="' + site.base_url + "assets/uploads/" + r.image + '" alt=""></a> </div>' +
                        '<div class="tag new"><span>new</span></div>' +
                        '</div>' +
                        '<div class="product-info text-left">' +
                        '<h3 class="name"><a href="' + site.site_url + "product/" + r.slug + '">' + t + '</a></h3>' +
                        '<div class="rating rateit-small"></div>' +
                        '<div class="description"></div>' +

                        '<div class="product-price"> <span class="price">' + desk_price + '</div>' +
                        ...
                        '<button class="btn btn-primary icon addToCart add-to-cart" data-toggle="dropdown" data-id="' + r.id + '" type="button"> <i class="fa fa-shopping-cart"></i> </button>' +
                        '<button class="btn btn-primary cart-btn addToCart add-to-cart" data-id="' + r.id + '" type="button">Add to cart</button>' +
                        '</li>' +
                        '<li class="lnk wishlist"> <a class="wishlist add-to-wishlis" data-id="' + r.id + '" href="javascript" title="Wishlist"> <i class="icon fa fa-heart"></i> </a> </li>' +
                        '</ul>' +
                        '</div>' +
                        '</div>' +
                        '</div>' +
...
function update_mini_cart(t) {
    ...
    if (t.total_items && t.total_items > 0) {
        ...
        $(".cart-total-items").text(t.total_items), $(".cart_value").html(t.total), $("#cart-items").empty(),
            $.each(t.contents, function() {
                var t = '<div class="col-xs-4"><div class="image"><a href="javascript:;"><img src="' + site.base_url + "assets/uploads/thumbs/" + this.image + '"></a></div></div><div class="col-xs-7"><h3 class="name"><a href="javascript:;">' + this.name + '</a></h3><div class="price">' + this.price + '</div></div></div>';
                $("<row class='test'>" + t + "</row>").appendTo("#cart-items")
            });

        var e = '<div class="clearfix"></div><hr><div class="clearfix cart-total"><div class="pull-right"> <span class="text">' + lang.total_items + '</span><span class="price">' + t.total + '</span></div><div class="clearfix"></div><a href="' + site.base_url + '/cart/checkout" class="btn btn-upper btn-primary btn-block m-t-20">Checkout</a></div>';
        $(".foo").html(e), $("#cart-empty").hide(), $("#cart-contents")
            //$("<tfoot class='tfoot'>" + e + "</tfoot>").appendTo("#cart-items"), $("#cart-empty").hide(), $("#cart-contents").show()
    } else $(".cart-total-items").text(0), $("#cart-contents").hide(), $("#cart-empty").show(), $('.foo').html('Your cart is empty!')
}



function update_mini_cart_old(t) {
    ...
    if (t.total_items && t.total_items > 0) {
        ...
        $(".cart-total-items").text(t.total_items), $(".cart_value").html(t.total), $("#cart-items").empty(),
            $.each(t.contents, function() {
                ...
                $("<tr class='test'>" + t + "</tr>").appendTo("#cart-items")
            });
    ...
    if (isMobile) {
        ...
        if (t.total_items && t.total_items > 0) {
            ...
            $.each(t.contents, function() {
                ...
                this.options && (s += '<select name="' + e + '[option]" class="selectpicker cart-item-option" data-width="100%" data-style="btn-default">',
        ...
        if (t.total_items && t.total_items > 0) {
            ...
            $.each(t.contents, function() {
                var t = this,
                    s = '\n  <td class="remove-itemsss">\n <a href="#" class="icon remove-item" data-rowid="' + this.rowid + '"><i class="fa fa-trash-o"></i><a>\n </td>\n  <td><input type="hidden" name="' + e + '[rowid]" value="' + this.rowid + '">' + e + '</td>\n  <td class="cart-image">\n <a class="entry-thumbnail"><img  src="' + site.base_url + "assets/uploads/thumbs/" + this.image + '" alt=""></a>\n            </td>\n            <td class="cart-product-name-info"><h4 class="cart-product-description">' + this.name + "</h4></td>\n            <td style='display: none'>";
                this.options && (s += '<select name="' + e + '[option]" class="selectpicker cart-item-option" data-width="100%" data-style="btn-default">',
                    $.each(this.options, function() {
                        s += '<option value="' + this.id + '" ' + (this.id == t.option ? "selected" : "") + ">" + this.name + " " + (0 != parseFloat(this.price) ? "(+" + this.price + ")" : "") + "</option>"
                    }), s += "</select>"), s += '</td>\n <td class="cart-product-quantity"><div class="quant-input"><div class="arrows"><div class="arrow plus gradient"><span class="ir"><i class="icon fa fa-sort-asc"></i></span></div><div class="arrow minus gradient"><span class="ir"><i class="icon fa fa-sort-desc"></i></span></div></div><input type="text" name="' + e + '[qty]" class="input-qty cart-item-qty" value="' + this.qty + '"></div></td>\n            <td class="cart-product-sub-total"><span class="cart-sub-total-price">' + this.price + '</span></td>\n     <td class="cart-product-grand-total"><span class="cart-grand-total-price">' + this.subtotal + "</span></td>\n            ", e++, $('<tr id="' + this.rowid + '">' + s + "</tr>").appendTo("#cart-table tbody")
            }), $("#cart-totals").empty();

            var s = "<thead><tr><th><div class='cart-sub-total' style='text-align: left'>" + lang.total_w_o_tax + '<span class="inner-left-md pull-right">' + t.subtotal + "</span></div><div class='cart-sub-total' style='text-align: left'>" + lang.product_tax + '<span class="inner-left-md pull-right">' + t.total_item_tax + "</span></div><div class='cart-sub-total' style='text-align: left'>" + lang.total + '<span class="inner-left-md pull-right">' + t.total + "</span></div><div class='cart-sub-total' style='text-align: left'>" + lang.order_tax + '<span class="inner-left-md pull-right">' + t.order_tax + "</span></div><div class='cart-sub-total' style='text-align: left'>" + lang.shipping + '<span class="inner-left-md pull-right">' + t.shipping + "</span></div><div class='cart-grand-total' style='text-align: left'>" + lang.grand_total + '<span class="inner-left-md pull-right">' + t.grand_total + "</span></div></th></tr>";
            s += '<tr><td colspan="2"></td></tr>',
                s += '<tr style="display:none" class="active text-bold"><td>' + lang.grand_total + '</td><td class="text-right">' + t.grand_total + "</td></tr>", $("<tbody>" +
                    s + "</tbody>").appendTo("#cart-totals"), $("#total-items").text(t.total_items + "(" + t.total_unique_items + ")"), $(".cart-item-option").selectpicker("refresh"), $(".cart-empty-msg").hide(), $(".cart-contents").show()
        } else $("#total-items").text(t.total_items), $(".cart-contents").hide(), $(".cart-empty-msg").show()
...
function saa_alert(t, e, s, a) {
    s = s || "delete", e = e || "This action can't be reverted back.", a = a || {}, a._method = s, a[site.csrf_token] = site.csrf_token_value, Swal.fire({
        title: "Are you sure?",
        html: e,
        type: "question",
        showCancelButton: !0,
    ...
    if ($(document).on("click", ".add-to-cart", function(t) {
            ...
            $.ajax({
                ...
                if (t.error) {
                    ...
                    sa_alert("Notice!", t.message, "error", !0);
